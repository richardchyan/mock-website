   ...
   return ( 
      ...
      <div className="font-roboto flex flex-col">
         <div className="font-roboto flex flex-col">
            ...
            <button className="uppercase bg-blue-100 text-md lg:text-xl  text-black p-3 rounded-lg m-auto mt-3 hover:bg-blue-300"> 
         ...
         <div className="font-roboto mt-20 pb-4 m-auto w-4/5 grid grid-cols-1 md:grid-cols-3 gap-10 text-xl text-white max-w-screen-xl" >
            <div className="font-roboto text-xl text-white">
               ...
               <button className="uppercase my-4 bg-yellow-100 text-md lg:text-xl text-black p-3 rounded-lg hover:bg-yellow-200">
